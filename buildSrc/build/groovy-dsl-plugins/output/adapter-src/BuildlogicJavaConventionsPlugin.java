...
/**
 * Precompiled buildlogic.java-conventions script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class BuildlogicJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_BuildlogicJavaConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_BuildlogicJavaConventions").asSubclass(BasicScript.class);
