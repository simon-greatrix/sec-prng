...
/**
 * Read previously stored data back from a byte array. As the data has already been read into memory, the only possible IOException is an EOFException or a
 * UTFEncodingException. Both exceptions would indicate the data had been corrupted in storage.
 *
...
public class SeedInput implements DataInput {
  ...
  public boolean readBoolean() throws EOFException {
    if (position == length) {
      throw new EOFException("0 bytes remaining");
    }
