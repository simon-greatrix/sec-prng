...
/**
 * Store seed data in the JVM's system or user preferences storage. Note that
 * using this kind of storage may require the 'preferences' privilege.
 * 
...
public abstract class PreferenceStorage extends SeedStorage {
     ...
     *             if the preferences cannot be retrieved
     */
