...
public class HashSpec {
   ...
   * bit input is padded with an 0x80 byte and a 64-bit message length value to create a 512-bit block.
   */
   ...
   * 440 bit input is padded with an 0x80 byte and a 64-bit message length value to create a 512-bit block.
   */
   ...
   * 888 bit input is padded with an 0x80 byte and a 128-bit message length value to create a 1024-bit block.
   */
