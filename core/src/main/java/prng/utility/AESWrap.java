...
/**
 * Implementation of AES key wrapping according to RFC-5649. Whilst Java does
 * support AESWrap out-of-the-box, it is only compliant with the older RFC-3394
 * which restricted key sizes to multiples of 8 bytes. As not all keys conform
 * to this restriction, an implementation of the newer protocol is useful.
 *
